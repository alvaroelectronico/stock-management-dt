...
class DecisionTransformerConfig(PretrainedConfig):
    ...
    Args:
        ...
        allow_short_positions (`bool`, *optional*, defaults to False):
            Whether negative weights are allowed (short positions) or long only portfolios
        allow_leveraged_positions (`bool`, *optional*, defaults to False):
            Whether |w|>1 weights are allowed (leveraged positions)
        max_levarage (`int`, *optional*, defaults to 1): maximum leverage
    ...
    def __init__(
        ...
        self.allow_leveraged_positions = allow_leveraged_positions
