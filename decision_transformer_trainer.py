            ...
            while currentStep <= self.stepsPerEpoch:
                ...
                for window_start in range(0, trajectoryLength, 1):
                    ...
                    if window_end - window_start == self.model.maxSeqLength and window_end <= trajectoryLength:
                        ...
                        # Solo hacer predicciones cuando tengamos una ventana completa
                        # Forward pass para la ventana actual, pasando la acción real como nextOrderQuantity

                        nextAction = orderQuantityData[:, window_end - 1:window_end]
                        td = self.model.forward(td, nextOrderQuantity=nextAction)
